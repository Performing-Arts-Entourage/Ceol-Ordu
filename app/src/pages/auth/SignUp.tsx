    ...
    return (
        <div className="flex min-h-full flex-col justify-center py-12 sm:px-6 lg:px-8 bg-gray-100 flex-grow">
            <div className="sm:mx-auto sm:w-full sm:max-w-md">
                ...
                <h2 className="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Sign up for a free account</h2>
                    ...
                    <Form className="space-y-6" onSubmit={onSubmit}>
                        ...
                        {/* <div className="flex">
                            <Button
                                ...
                                onClick={() => setSignInReceiver('email')}
                            >
                                <FontAwesomeIcon icon={faEnvelope} size="lg" className="mr-2" />
                                Email
                            </Button>
                            <Button
                                color={signInReceiver === 'phone' ? 'blue' : 'gray'}
                                outline={signInReceiver !== 'phone'}
                                radius="full"
                                size="sm"
                                className="flex items-center ml-2"
                                onClick={() => setSignInReceiver('phone')}
                            >
